Blender files, textures and modifications in this subdirectory for openxr demo use by Rune Berg is licensed under CC Attribution-NonCommercial-ShareAlike (http://creativecommons.org/licenses/by-nc-sa/4.0/).
